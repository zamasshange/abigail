      ...
      <div className="mx-auto max-w-md text-center">
        ...
        {answered === 'yes' && (
          <div className="mt-7 rounded-3xl border-2 border-foreground bg-card p-6 shadow-[0_8px_0_0_var(--foreground)]">
            ...
            <p className="mt-3 text-[15px] leading-relaxed text-foreground/85">
              {
                "I love you, Abigail. I'm not going to waste this. Call me when you read this — I'll pick up on the first ring, I promise."
              }
            </p>

            {noteState === 'sent' ? (
              <p className="mt-5 rounded-2xl bg-secondary px-4 py-3 text-sm font-semibold text-secondary-foreground">
                sent to Drake ♥ he&apos;s reading it right now.
              </p>
            ) : (
              <form
        ...
        {answered === 'time' && (
          <div className="mt-7 rounded-3xl border-2 border-foreground bg-card p-6 shadow-[0_8px_0_0_var(--foreground)]">
            ...
            <p className="mt-3 text-[15px] leading-relaxed text-foreground/85">
              {
                "Take all the time you need — I'm not going anywhere, and I'm not going to rush you. I still love you, and I'll still be here when you're ready."
              }
            </p>
            <button
              type="button"
